...
using System;
namespace Qwips.Core.MultiCase.Products.Item.Listprice {
    /// <summary>
...
#nullable restore
        ...
        public async Task<Productlistpricecollection> GetAsync(Action<ListpriceRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<Productlistpricecollection>(requestInfo, Productlistpricecollection.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
