...
using System;
namespace Qwips.Core.MultiCase.Giftcard.GetSender {
    /// <summary>
...
#nullable restore
        ...
        public async Task<Giftcardavsenderinfo> GetAsync(Action<GetSenderRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<Giftcardavsenderinfo>(requestInfo, Giftcardavsenderinfo.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
