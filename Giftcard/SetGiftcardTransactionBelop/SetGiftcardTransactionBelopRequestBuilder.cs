...
using System;
namespace Qwips.Core.ClientSdk.Multicase.Giftcard.SetGiftcardTransactionBelop {
    /// <summary>
...
#nullable enable
        public async Task<bool?> PostAsync(Qwips.Core.ClientSdk.Multicase.Models.Setgiftcardtransactionbelop body, Action<SetGiftcardTransactionBelopRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<bool?> PostAsync(Qwips.Core.ClientSdk.Multicase.Models.Setgiftcardtransactionbelop body, Action<SetGiftcardTransactionBelopRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Qwips.Core.ClientSdk.Multicase.Models.Setgiftcardtransactionbelop body, Action<SetGiftcardTransactionBelopRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Qwips.Core.ClientSdk.Multicase.Models.Setgiftcardtransactionbelop body, Action<SetGiftcardTransactionBelopRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
