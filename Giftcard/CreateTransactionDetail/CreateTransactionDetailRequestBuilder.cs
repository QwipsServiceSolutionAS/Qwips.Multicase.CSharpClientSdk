...
using System;
namespace Qwips.Core.ClientSdk.Multicase.Giftcard.CreateTransactionDetail {
    /// <summary>
...
#nullable restore
        ...
        public async Task<Giftcardtransdetailcreationresult> PostAsync(Creategiftcardtransactiondetail body, Action<CreateTransactionDetailRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<Giftcardtransdetailcreationresult>(requestInfo, Giftcardtransdetailcreationresult.CreateFromDiscriminatorValue, MulticaseErrorHandler.GenericErrorResponse, cancellationToken);
        }
        /// <param name="body">The request body</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
