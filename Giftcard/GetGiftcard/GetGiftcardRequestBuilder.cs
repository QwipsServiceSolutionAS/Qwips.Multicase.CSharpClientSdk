...
using System;
namespace Qwips.Core.ClientSdk.Multicase.Giftcard.GetGiftcard {
    /// <summary>
...
#nullable enable
        public async Task<Qwips.Core.ClientSdk.Multicase.Models.Giftcard?> GetAsync(Action<GetGiftcardRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Qwips.Core.ClientSdk.Multicase.Models.Giftcard> GetAsync(Action<GetGiftcardRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<Qwips.Core.ClientSdk.Multicase.Models.Giftcard>(requestInfo, Qwips.Core.ClientSdk.Multicase.Models.Giftcard.CreateFromDiscriminatorValue, MulticaseErrorHandler.GenericErrorResponse, cancellationToken);
        }
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
