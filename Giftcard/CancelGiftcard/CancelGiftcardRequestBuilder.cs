...
using System;
namespace Qwips.Core.MultiCase.Giftcard.CancelGiftcard {
    /// <summary>
...
#nullable enable
        public async Task<bool?> PostAsync(Qwips.Core.MultiCase.Models.Cancelgiftcard body, Action<CancelGiftcardRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<bool?> PostAsync(Qwips.Core.MultiCase.Models.Cancelgiftcard body, Action<CancelGiftcardRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Qwips.Core.MultiCase.Models.Cancelgiftcard body, Action<CancelGiftcardRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Qwips.Core.MultiCase.Models.Cancelgiftcard body, Action<CancelGiftcardRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
