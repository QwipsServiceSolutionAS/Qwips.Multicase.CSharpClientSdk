...
using Qwips.Core.ClientSdk.Multicase.Auth.Logout;
...
using System;
namespace Qwips.Core.ClientSdk.Multicase.Auth {
    /// <summary>
...
#nullable restore
        ...
        public async Task<Authresponse> GetAsync(Action<AuthRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<Authresponse>(requestInfo, Authresponse.CreateFromDiscriminatorValue, MulticaseErrorHandler.GenericErrorResponse, cancellationToken);
        }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Authresponse?> PostAsync(Qwips.Core.ClientSdk.Multicase.Models.Auth body, Action<AuthRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Authresponse> PostAsync(Qwips.Core.ClientSdk.Multicase.Models.Auth body, Action<AuthRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Qwips.Core.ClientSdk.Multicase.Models.Auth body, Action<AuthRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Qwips.Core.ClientSdk.Multicase.Models.Auth body, Action<AuthRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
