...
using System;
namespace Qwips.Core.ClientSdk.Multicase.B24.Pricat.Export {
    /// <summary>
...
#nullable restore
        ...
        public async Task<Pricatresult> PostAsync(Pricatrequest body, Action<ExportRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<Pricatresult>(requestInfo, Pricatresult.CreateFromDiscriminatorValue, MulticaseErrorHandler.GenericErrorResponse, cancellationToken);
        }
        /// <param name="body">The request body</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
