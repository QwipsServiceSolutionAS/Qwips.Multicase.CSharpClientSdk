...
using System;
namespace Qwips.Core.MultiCase.MSystem.Usercompany.Departments {
    /// <summary>
...
#nullable restore
        ...
        public async Task<List<Department2>> GetAsync(Action<DepartmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<Department2>(requestInfo, Department2.CreateFromDiscriminatorValue, default, cancellationToken);
