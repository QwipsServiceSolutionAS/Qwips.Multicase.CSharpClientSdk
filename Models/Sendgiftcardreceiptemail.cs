...
namespace Qwips.Core.ClientSdk.Multicase.Models {
    public class Sendgiftcardreceiptemail : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new Sendgiftcardreceiptemail and sets the default values.
        /// </summary>
        public Sendgiftcardreceiptemail() {
        ...
        public static Sendgiftcardreceiptemail CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Sendgiftcardreceiptemail();
        }
        /// <summary>
