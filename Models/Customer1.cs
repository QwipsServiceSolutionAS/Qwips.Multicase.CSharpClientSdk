...
namespace Qwips.Core.MultiCase.Models {
    public class Customer1 : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Customer1_RegisteredBy? RegisteredBy { get; set; }
#nullable restore
#else
        public Customer1_RegisteredBy RegisteredBy { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Customer1_Responsible1? Responsible1 { get; set; }
#nullable restore
#else
        public Customer1_Responsible1 Responsible1 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Customer1_Responsible2? Responsible2 { get; set; }
#nullable restore
#else
        public Customer1_Responsible2 Responsible2 { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Customer1_Sender? Sender { get; set; }
#nullable restore
#else
        public Customer1_Sender Sender { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new Customer1 and sets the default values.
        /// </summary>
        public Customer1() {
        ...
        public static Customer1 CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"RegisteredBy", n => { RegisteredBy = n.GetObjectValue<Customer1_RegisteredBy>(Customer1_RegisteredBy.CreateFromDiscriminatorValue); } },
                {"RegisteredDate", n => { RegisteredDate = n.GetDateTimeOffsetValue(); } },
                {"Responsible1", n => { Responsible1 = n.GetObjectValue<Customer1_Responsible1>(Customer1_Responsible1.CreateFromDiscriminatorValue); } },
                {"Responsible2", n => { Responsible2 = n.GetObjectValue<Customer1_Responsible2>(Customer1_Responsible2.CreateFromDiscriminatorValue); } },
                {"Sender", n => { Sender = n.GetObjectValue<Customer1_Sender>(Customer1_Sender.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Customer1_RegisteredBy>("RegisteredBy", RegisteredBy);
            writer.WriteDateTimeOffsetValue("RegisteredDate", RegisteredDate);
            writer.WriteObjectValue<Customer1_Responsible1>("Responsible1", Responsible1);
            writer.WriteObjectValue<Customer1_Responsible2>("Responsible2", Responsible2);
            writer.WriteObjectValue<Customer1_Sender>("Sender", Sender);
