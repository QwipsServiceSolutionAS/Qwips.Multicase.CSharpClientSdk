...
namespace Qwips.Core.MultiCase.Models {
    public class Combinedinvoice1 : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new combinedinvoice1 and sets the default values.
        /// </summary>
        public Combinedinvoice1() {
        ...
        public static Combinedinvoice1 CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Combinedinvoice1();
        }
        /// <summary>
