...
namespace Qwips.Core.MultiCase.Models {
    public class Sendgiftcardreceiptsms : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new Sendgiftcardreceiptsms and sets the default values.
        /// </summary>
        public Sendgiftcardreceiptsms() {
        ...
        public static Sendgiftcardreceiptsms CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Sendgiftcardreceiptsms();
        }
        /// <summary>
