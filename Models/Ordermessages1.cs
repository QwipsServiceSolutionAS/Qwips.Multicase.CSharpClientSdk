...
namespace Qwips.Core.ClientSdk.Multicase.Models {
    public class Ordermessages1 : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new ordermessages1 and sets the default values.
        /// </summary>
        public Ordermessages1() {
        ...
        public static Ordermessages1 CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Ordermessages1();
        }
        /// <summary>
