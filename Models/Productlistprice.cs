...
namespace Qwips.Core.MultiCase.Models {
    public class Productlistprice : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public string ProductNumber { get; set; }
#endif
        /// <summary>The WarehouseListPrices property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Productwarehouselistprice>? WarehouseListPrices { get; set; }
#nullable restore
#else
        public List<Productwarehouselistprice> WarehouseListPrices { get; set; }
#endif
        /// <summary>
        /// Instantiates a new productlistprice and sets the default values.
        /// </summary>
        public Productlistprice() {
        ...
        public static Productlistprice CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Productlistprice();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"WarehouseListPrices", n => { WarehouseListPrices = n.GetCollectionOfObjectValues<Productwarehouselistprice>(Productwarehouselistprice.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Productwarehouselistprice>("WarehouseListPrices", WarehouseListPrices);
