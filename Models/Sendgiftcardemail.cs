...
namespace Qwips.Core.MultiCase.Models {
    public class Sendgiftcardemail : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new Sendgiftcardemail and sets the default values.
        /// </summary>
        public Sendgiftcardemail() {
        ...
        public static Sendgiftcardemail CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Sendgiftcardemail();
        }
        /// <summary>
