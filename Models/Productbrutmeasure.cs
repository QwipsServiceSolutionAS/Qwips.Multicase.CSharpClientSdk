...
namespace Qwips.Core.ClientSdk.Multicase.Models {
    public class Productbrutmeasure : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new productbrutmeasure and sets the default values.
        /// </summary>
        public Productbrutmeasure() {
        ...
        public static Productbrutmeasure CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Productbrutmeasure();
        }
        /// <summary>
