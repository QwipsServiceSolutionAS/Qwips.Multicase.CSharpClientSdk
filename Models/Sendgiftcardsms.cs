...
namespace Qwips.Core.ClientSdk.Multicase.Models {
    public class Sendgiftcardsms : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new Sendgiftcardsms and sets the default values.
        /// </summary>
        public Sendgiftcardsms() {
        ...
        public static Sendgiftcardsms CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Sendgiftcardsms();
        }
        /// <summary>
