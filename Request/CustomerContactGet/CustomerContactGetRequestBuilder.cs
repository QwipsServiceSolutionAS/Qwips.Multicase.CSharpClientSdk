...
using System;
namespace Qwips.Core.MultiCase.Request.CustomerContactGet {
    /// <summary>
...
#nullable enable
        public async Task<CustomerContactGetResponse?> PostAsync(Qwips.Core.MultiCase.Models.Customercontactget body, Action<CustomerContactGetRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CustomerContactGetResponse> PostAsync(Qwips.Core.MultiCase.Models.Customercontactget body, Action<CustomerContactGetRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<CustomerContactGetResponse>(requestInfo, CustomerContactGetResponse.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Retrieve one or more contacts for the given customer. Setting the ContactID to 0 will retrieve all contacts for the given customer
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Qwips.Core.MultiCase.Models.Customercontactget body, Action<CustomerContactGetRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Qwips.Core.MultiCase.Models.Customercontactget body, Action<CustomerContactGetRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
