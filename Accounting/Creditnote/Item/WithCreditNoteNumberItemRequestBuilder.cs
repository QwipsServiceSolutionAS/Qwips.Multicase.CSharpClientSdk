...
using System;
namespace Qwips.Core.MultiCase.Accounting.Creditnote.Item {
    /// <summary>
...
#nullable enable
        public async Task<Qwips.Core.MultiCase.Models.Creditnote?> GetAsync(Action<WithCreditNoteNumberItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Qwips.Core.MultiCase.Models.Creditnote> GetAsync(Action<WithCreditNoteNumberItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<Qwips.Core.MultiCase.Models.Creditnote>(requestInfo, Qwips.Core.MultiCase.Models.Creditnote.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Get the specified creditnote
        /// </summary>
