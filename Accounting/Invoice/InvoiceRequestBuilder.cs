...
using Qwips.Core.MultiCase.Accounting.Invoice.Item;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Qwips.Core.MultiCase.Accounting.Invoice {
    /// <summary>
    ...
    public class InvoiceRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Qwips.Core.MultiCase.accounting.invoice.item collection</summary>
