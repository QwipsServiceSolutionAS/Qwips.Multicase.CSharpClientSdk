...
using System;
namespace Qwips.Core.MultiCase.Accounting.Updatecustomerbalance {
    /// <summary>
...
#nullable enable
        public async Task<Responsestatus?> PostAsync(List<Qwips.Core.MultiCase.Models.Updatecustomerbalance> body, Action<UpdatecustomerbalanceRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Responsestatus> PostAsync(List<Qwips.Core.MultiCase.Models.Updatecustomerbalance> body, Action<UpdatecustomerbalanceRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(List<Qwips.Core.MultiCase.Models.Updatecustomerbalance> body, Action<UpdatecustomerbalanceRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(List<Qwips.Core.MultiCase.Models.Updatecustomerbalance> body, Action<UpdatecustomerbalanceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
