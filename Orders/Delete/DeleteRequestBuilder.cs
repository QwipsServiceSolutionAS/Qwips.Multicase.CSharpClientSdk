...
using System;
namespace Qwips.Core.MultiCase.Orders.Delete {
    /// <summary>
...
#nullable restore
        ...
        public async Task<Ordercreationresult> PostAsync(Deleteorder body, Action<DeleteRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<Ordercreationresult>(requestInfo, Ordercreationresult.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Deletes an Order
        /// </summary>
