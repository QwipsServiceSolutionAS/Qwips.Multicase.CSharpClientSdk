...
using System;
namespace Qwips.Core.MultiCase.EHF.ProductCatalog {
    /// <summary>
...
#nullable restore
        ...
        public async Task<Ehfresult> PostAsync(Ehfrequest body, Action<ProductCatalogRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<Ehfresult>(requestInfo, Ehfresult.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <param name="body">The request body</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
