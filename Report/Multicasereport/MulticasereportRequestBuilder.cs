...
using System;
namespace Qwips.Core.ClientSdk.Multicase.Report.Multicasereport {
    /// <summary>
...
#nullable enable
        public async Task<Qwips.Core.ClientSdk.Multicase.Models.Report?> PostAsync(Getmulticasereport body, Action<MulticasereportRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Qwips.Core.ClientSdk.Multicase.Models.Report> PostAsync(Getmulticasereport body, Action<MulticasereportRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Qwips.Core.ClientSdk.Multicase.Models.Report>(requestInfo, Qwips.Core.ClientSdk.Multicase.Models.Report.CreateFromDiscriminatorValue, MulticaseErrorHandler.GenericErrorResponse, cancellationToken);
        }
        /// <summary>
        /// Retrieve a multicase report
        /// </summary>
