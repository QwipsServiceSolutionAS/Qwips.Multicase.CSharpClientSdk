...
using System;
namespace Qwips.Core.ClientSdk.Multicase.Warehouses.Stocklevels.Search {
    /// <summary>
    /// Builds and executes requests for operations under \warehouses\stocklevels\search
    /// </summary>
    public class SearchRequestBuilder : BaseRequestBuilder {
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/warehouses/stocklevels/search{?ProductNumber*,ProductDescription*,WarehouseId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SearchRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/warehouses/stocklevels/search{?ProductNumber*,ProductDescription*,WarehouseId*}", rawUrl) {
        }
        /// <summary>
        /// Search for products and retrieve their stock levels at all warehouses
        /// </summary>
